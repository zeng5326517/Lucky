...
var flag6,flag7,flag8;//循环显示标识符,关闭循环显示时使用clearInterval(flag6);
...
var begin = function(){
    if(!beginflag){
        ...
        num7 = 4;
        num8 = 1;
        flag6 = self.setInterval("change6()",50);
        flag7 = self.setInterval("change7()",50);
        flag8 = self.setInterval("change8()",50);
        beginflag=true;
    }
}
